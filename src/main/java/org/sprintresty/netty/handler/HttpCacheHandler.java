...
public class HttpCacheHandler extends SimpleChannelHandler {
    ...
    public void handleDownstream(ChannelHandlerContext ctx, ChannelEvent e) throws Exception {
        if (e instanceof MessageEvent && ((MessageEvent)e).getMessage() instanceof HttpCachableResponse) {
            HttpCachableResponse r = (HttpCachableResponse)((MessageEvent)e).getMessage();

            //可以把数据Html缓存到Redis中
            //redis.set(r.getRequestUri, r.getContent());
