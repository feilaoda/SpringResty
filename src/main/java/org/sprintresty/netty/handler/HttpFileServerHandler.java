...
public class HttpFileServerHandler extends SimpleChannelUpstreamHandler {
    ...
    public HttpFileServerHandler(String path, String stripFromUri) {
        this(path);
        this.stripFromUri = stripFromUri;
    }

    public HttpFileServerHandler(String path, int cacheMaxAge) {
        this(path);
        this.cacheMaxAge = cacheMaxAge;
    }

    public HttpFileServerHandler(String path, int cacheMaxAge, String stripFromUri) {
    ...
    public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) throws Exception {
        ...
        HttpCachableResponse response = new HttpCachableResponse(HTTP_1_1, OK);
